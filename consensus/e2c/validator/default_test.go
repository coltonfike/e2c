...
func testNewValidatorSet(t *testing.T) {
	...
	// Create ValidatorSet
	valSet := NewSet(ExtractValidators(b), e2c.RoundRobin)
	if valSet == nil {
...
func testNormalValSet(t *testing.T) {
	...
	valSet := newDefaultSet([]common.Address{addr1, addr2}, e2c.RoundRobin)
	if valSet == nil {
...
func testEmptyValSet(t *testing.T) {
	valSet := NewSet(ExtractValidators([]byte{}), e2c.RoundRobin)
	if valSet == nil {
...
func testStickyProposer(t *testing.T) {
	...
	valSet := newDefaultSet([]common.Address{addr1, addr2}, e2c.Sticky)
