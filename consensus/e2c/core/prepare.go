...
func (c *core) handlePrepare(msg *message, src e2c.Validator) error {
	// Decode PREPARE message
	var prepare *e2c.Subject
...
func (c *core) verifyPrepare(prepare *e2c.Subject, src e2c.Validator) error {
...
func (c *core) acceptPrepare(msg *message, src e2c.Validator) error {
	logger := c.logger.New("from", src, "state", c.state)
