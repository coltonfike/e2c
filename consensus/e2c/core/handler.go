...
func (c *core) handleMsg(payload []byte) error {
	...
	if src == nil {
		...
		return e2c.ErrUnauthorizedAddress
	}

	return c.handleCheckedMsg(msg, src)
}

func (c *core) handleCheckedMsg(msg *message, src e2c.Validator) error {
