...
func (c *core) currentView() *e2c.View {
	return &e2c.View{
...
func (c *core) catchUpRound(view *e2c.View) {
...
func (c *core) updateRoundState(view *e2c.View, validatorSet e2c.ValidatorSet, roundChange bool) {
...
func (c *core) checkValidatorSignature(data []byte, sig []byte) (common.Address, error) {
	return e2c.CheckValidatorSignature(c.valSet, data, sig)
}
