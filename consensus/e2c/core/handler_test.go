...
func TestHandleMsg(t *testing.T) {
	...
	// with a matched payload. msgPreprepare should match with *e2c.Preprepare in normal case.
	msg := &message{
		Code:          msgPreprepare,
		Msg:           m,
		Address:       v0.Address(),
	...
	// with a unmatched payload. msgPrepare should match with *e2c.Subject in normal case.
	msg = &message{
		Code:          msgPrepare,
		Msg:           m,
		Address:       v0.Address(),
	...
	// with a unmatched payload. e2c.MsgCommit should match with *e2c.Subject in normal case.
	msg = &message{
		Code:          msgCommit,
		Msg:           m,
		Address:       v0.Address(),
