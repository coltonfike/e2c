...
func (c *core) handleRequest(request *e2c.Request) error {
...
func (c *core) checkRequestMsg(request *e2c.Request) error {
...
func (c *core) storeRequestMsg(request *e2c.Request) {
...
func (c *core) processPendingRequests() {
	...
	for !(c.pendingRequests.Empty()) {
		...
		go c.sendEvent(e2c.RequestEvent{
			Proposal: r.Proposal,
		})
	}
}
