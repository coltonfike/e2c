...
func newTestPreprepare(v *e2c.View) *e2c.Preprepare {
	return &e2c.Preprepare{
		View:     v,
...
func TestHandlePreprepareWithLock(t *testing.T) {
	...
	testCases := []struct {
		system       *testSystem
		proposal     e2c.Proposal
		lockProposal e2c.Proposal
	}{
		{
			newSystem(),
			proposal,
