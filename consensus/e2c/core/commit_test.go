...
func TestVerifyCommit(t *testing.T) {
	...
	valSet := validator.NewSet([]common.Address{peer.Address()}, e2c.RoundRobin)
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: nil,
			commit: &e2c.Subject{
				View:   &e2c.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&e2c.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
				valSet,
			),
		},
		{
			...
			roundState: newTestRoundState(
				&e2c.View{Round: big.NewInt(1), Sequence: big.NewInt(1)},
				valSet,
			),
		},
		{
		...
		},
		{
			...
			expected: errInconsistentSubject,
			commit: &e2c.Subject{
				View:   &e2c.View{Round: big.NewInt(0), Sequence: nil},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&e2c.View{Round: big.NewInt(1), Sequence: big.NewInt(1)},
		...
		},
		{
			...
			expected: errInconsistentSubject,
			commit: &e2c.Subject{
				View:   &e2c.View{Round: big.NewInt(1), Sequence: big.NewInt(0)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&e2c.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
		...
		},
		{
			...
			expected: errInconsistentSubject,
			commit: &e2c.Subject{
				View:   &e2c.View{Round: big.NewInt(0), Sequence: big.NewInt(1)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&e2c.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
