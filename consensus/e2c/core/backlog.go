...
func (c *core) checkMessage(msgCode uint64, view *e2c.View) error {
...
func (c *core) storeBacklog(msg *message, src e2c.Validator) {
...
func toPriority(msgCode uint64, view *e2c.View) float32 {
	if msgCode == msgRoundChange {
