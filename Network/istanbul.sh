...
geth --verbosity 0 --datadir node1 init istanbul.json
geth --verbosity 0 --datadir node2 init istanbul.json
geth --verbosity 0 --datadir node3 init istanbul.json
geth --verbosity 0 --datadir node4 init istanbul.json
geth --verbosity 0 --datadir client init istanbul.json
